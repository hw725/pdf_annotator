...
import { Document, Page, pdfjs } from "react-pdf";import { useCallback } from "react";
...
import workerSrc from "pdfjs-dist/build/pdf.worker.min.mjs?url";import "react-pdf/dist/esm/Page/TextLayer.css";

import PDFHighlight from "./PDFHighlight";import workerSrc from "pdfjs-dist/build/pdf.worker.min.mjs?url";

import PageHighlightOverlay from "./PageHighlightOverlay";

// Configure pdf.js worker for Vite/ESM

// Configure pdf.js worker for Vite/ESMpdfjs.GlobalWorkerOptions.workerSrc = workerSrc;
...
const PDFViewer = ({  file,
  ...
  initialAnnotations = [],  onAnnotationChange,

  onAnnotationChange,  onLoadSuccess,
  ...
  const [scale, setScale] = useState(1.0);  const containerRef = useRef(null);
