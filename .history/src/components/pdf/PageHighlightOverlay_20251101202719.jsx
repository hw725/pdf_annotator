...
const PageHighlightOverlay = ({
  ...
  function hitTestHighlight(px, py, h) {
    ...
    if (h.type === "text" && Array.isArray(h.rects)) {
      return h.rects.some((r) => px >= r.x && py >= r.y && px <= r.x + r.width && py <= r.y + r.height);
    }
    return false;
  }
  ...
  return (
    <div
      ...
      style={{
        ...
        bottom: 0,
        left: 0,
        pointerEvents: highlightMode === "area" || !highlightMode ? "auto" : "none",
        zIndex: 10,
      }}
    >
      <canvas
        ...
        style={{
          ...
          height: "100%",
          pointerEvents: highlightMode === "area" || !highlightMode ? "auto" : "none",
          cursor: highlightMode === "area" ? "crosshair" : (!highlightMode ? "pointer" : "default"),
        }}
      />
      {menuPos && selectedId && (
        <div
