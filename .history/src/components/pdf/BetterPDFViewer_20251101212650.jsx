      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <button
            ...
            style={{ padding: "4px 8px", border: "1px solid #e5e7eb", borderRadius: 4, background: "#fff" }}
          >
            ←
          </button>
          <input
            ...
            style={{ width: 64, textAlign: "center", padding: "4px 6px", border: "1px solid #e5e7eb", borderRadius: 4 }}
          />
          <span>/ {numPages || "?"}</span>
          <button
            onClick={() => goToPage(currentPage + 1)}
        ...
        >
          <button onClick={zoomOut} style={{ padding: "4px 8px", border: "1px solid #e5e7eb", borderRadius: 4, background: "#fff" }}>-</button>
          <span style={{ width: 56, textAlign: "center" }}>
            {Math.round(scale * 100)}%
          </span>
          <button onClick={zoomIn} style={{ padding: "4px 8px", border: "1px solid #e5e7eb", borderRadius: 4, background: "#fff" }}>+</button>
          <div
            style={{
              display: "flex",
              gap: 4,
