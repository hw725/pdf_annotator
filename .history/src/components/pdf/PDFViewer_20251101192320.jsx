            ...
            <Document
              ...
              error={
                <div style={{ padding: 24, color: "#dc2626", maxWidth: 720 }}>
                  <div style={{ fontWeight: 600, marginBottom: 8 }}>PDF를 로드할 수 없습니다.</div>
                  {pdfError && (
                    <div style={{ whiteSpace: "pre-wrap", fontFamily: "ui-monospace, SFMono-Regular, Menlo, Consolas, monospace", fontSize: 12 }}>
                      {pdfError}
                    </div>
                  )}
                  <ul style={{ marginTop: 8, color: "#9ca3af", fontSize: 12, paddingLeft: 18 }}>
                    <li>외부 PDF의 CORS 또는 Range 요청이 허용되어야 합니다.</li>
